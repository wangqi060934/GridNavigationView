...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (mMenuView == null) {
            ...
            GridLayoutManager gridLayoutManager=new GridLayoutManager(root.getContext(),gridColumn);
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                @Override
                public int getSpanSize(int position) {
                    return mAdapter.getItemViewType(position)==NavigationMenuAdapter.VIEW_TYPE_NORMAL?
                            1:gridColumn;
                }
            });
            mMenuView.setLayoutManager(gridLayoutManager);
